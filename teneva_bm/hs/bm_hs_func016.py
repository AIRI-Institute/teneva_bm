...
class BmHsFunc016(Bm):
    def __init__(self, d=2, n=64, seed=42, name=None):
        super().__init__(d, n, seed, name)
        self.set_desc("""
            The function 016 from the Hock & Schittkowski collection.
            ...
            C - equation function
                x[0] + x[1]^2 >= 0
                x[0]^2 + x[1] >= 0
            The exact global minimum is known: x = [0.5, 0.25], y = 0.25.
            Hyperparameters: 
        ...
        self.set_grid([-0.5, -10], [0.5, 1])
        self.set_min(x=[0.5, 0.25], y=0.25)
